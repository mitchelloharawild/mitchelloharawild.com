...
tags:
  ...
  - cran
  - time series
image: 'tsibbledata-opengraph.png'
image-alt: 'tsibbledata: diverse datasets for tsibble'
citation:
  id: oharawild2019tsibbledata
---
...
`r htmltools::img(src = "tsibbledata.png", class = "hex")` The [tsibbledata](https://cran.r-project.org/package=tsibbledata) package provides a diverse collection of datasets for learning how to work with tidy time series data. There are 12 time series datasets included in the package, each of which featuring a unique time series characteristics or structures. These datasets are stored as [tsibble objects](http://tsibble.tidyverts.org/), which allows time series data to be used with the [tidyverse](https://www.tidyverse.org/).
